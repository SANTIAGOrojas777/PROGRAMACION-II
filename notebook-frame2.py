...
btn_frame.grid(row=7, column=1, columnspan=2, pady=5, sticky="w")
...
"""DOCTORES"""
#TITULO
labelTitulo=tk.Label(frameDoctores, text="REGISTRO DE DOCTORES")
labelTitulo.grid(row=0, column=1, sticky="w")

#NOMBRE
labelNombreP=tk.Label(frameDoctores, text="Nombre Completo:")
labelNombreP.grid(row=1, column=0, sticky="w", pady=5, padx=5)
NombreEntryP=tk.Entry(frameDoctores)
...
comboEspecialidad=ttk.Combobox(frameDoctores, values=["Cardiología", "Neurología", "Pediatría", "Traumatología"], textvariable=especialidad)
comboEspecialidad.grid(row=2, column=1, sticky="w", pady=5, padx=5)

#EDAD
labelEdad=tk.Label(frameDoctores, text="Edad:")
labelEdad.grid(row=3, column=0, padx=5, pady=5, sticky="w")
spin=tk.Spinbox(frameDoctores, from_=1, to=100, state="readonly")
...
btn_frame2.grid(row=5, column=1, columnspan=2, pady=5, sticky="w")

#BOTON PARA REGISTRAR
btn_registrar2=tk.Button(btn_frame2, text="Registrar", command="", bg="green")
...
#UBICAR EL TREEVIEW EN LA CUADRICULA
treeview2.grid(row=6, column=0, columnspan=2, sticky="nsew", padx=5, pady=10)
...
scroll_y2.grid(row=8, column=2, sticky="ns")
